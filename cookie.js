(function() {
    var h = {},
        mt = {},
        c = {
            id: "2b0f0945031c52df2a103f3ed5d7c3aa",
            dm: ["play.baidu.com"],
    ...
    (function() {
        var a = {
            ...
            q: function(a, f) {
                this.j[a] = this.j[a] || [];
                for (var d = this.j[a].length, g = 0; g < d; g++) this.j[a][g](f)
            }
        };
        return h.r = a
    })();
    ...
    (function() {
        ...
        function b() {
            ...
            if ((!m || !k) && e && l) u = p, t = +new Date;
            else if (m && k && (!e || !l)) u = r, s += +new Date - t;
            m = e;
            k = l;
            x = setTimeout(b, 100)
        }
        ...
        function d(a) {
            if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window)) l = "focus" == a.type || "focusin" == a.type ? p : r, b()
        }
        var g = mt.event,
            n = h.r,
            m = p,
            ...
            e = {
                ...
                fa: function() {
                    if ("undefined" === typeof window._bdhm_account || window._bdhm_account === c.id) {
                        ...
                        var a = window._hmt;
                        if (a && a.length)
                            for (var b = 0, f = a.length; b < f; b++) d.e(a[b],
                ...
                ga: function() {
                    if (0 < e.o.length)
                        for (var a = 0, b = e.o.length; a < b; a++) e.I(e.o[a]);
                    e.o = q
                },
                I: function(a) {
                    if (d.e(a, "Array")) {
                        var b = a[0];
                        if (e.hasOwnProperty(b) && d.e(e[b], "Function")) e[b](a)
                    }
                },
                ...
                _trackMobConv: function(a) {
                    if (a = {
                            ...
                            callback: 5,
                            share: 6
                        }[a[1]]) e.c |= 32, h.b.a.et = 93, h.b.a.ep = a, h.b.h()
                },
                ...
                _trackRTEvent: function(b) {
                    ...
                    if (d.e(b, "Object")) {
                        ...
                        var f = function(a) {
                            ...
                            m = b.length;
                        if (900 >= m) f.call(this, b);
                        else
                            for (var m = Math.ceil(m / 900), t = "block|" + Math.round(Math.random() * n.m).toString(16) + "|" + m + "|", s = [], u = 0; u < m; u++) s.push(u), s.push(b.substring(900 * u, 900 * u + 900)), f.call(this, t + s.join("|")),
                                s = []
                    }
                },
        ...
        a.prototype = {
            ...
            O: function() {
                for (var a = 0, b = c.dm.length; a < b; a++) {
                    var d = c.dm[a];
                    if (-1 < d.indexOf("/") && this.S(document.location.href, d)) return d.replace(/^[^\/]+(\/.*)/, "$1") + "/"
                }
                return "/"
            },
            na: function() {
                if (!document.referrer) return l.i - l.l > c.vdur ? 1 : 4;
                var a =
                    r;
            ...
            za: function() {
                ...
                if (d = this.getData("Hm_lvt_" + c.id)) {
                    ...
                    for (; 2592E3 < l.i - e[0];) e.shift();
                    f = 4 > e.length ? 2 : 3;
                    for (1 === a && e.push(l.i); 4 < e.length;) e.shift();
                    d = e.join(",");
                    e = e[e.length - 1]
                } else d = l.i, e = "", f = 1;
            ...
            $: function() {
                var a = document.location.hash.substring(1),
                    d = RegExp(c.id),
                    e = -1 < document.referrer.indexOf(l.Y) ? p : r,
                    f = b.k(a, "jn"),
